      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Nilai List</h3>
          </div>
          <!-- /.box-header -->
              ...
              <div class="login-box-body form-horizontal">
                <form method='post' id="pencarian_nilai">
                  <div class='form-group'>
                    ...
                    <div class='col-xs-7'>
                      <select name='matakuliah' id='matakuliah_nilai' type='text' class='form-control' required>
                        <option></option>
                        <?php
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-xs-7'>
                      <select name='jenis' id='jenis_nilai' type='text' class='form-control' required>
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-xs-7'>
                      <select name='kelas' id='kelas_nilai' type='text' class='form-control' required>
                        <option></option>
                      </select>
                    </div>
                  </div>
                  <div class="col-xs-12" style="margin-top:7%;margin-left:5%;">
                    <button type="submit" class="btn btn-block btn-success pull-right" id="cari_nilai"><i class="fa fa-search"></i> <strong>Cari</strong></button>
                  </div>
                </form>
              </div>
            </div>
